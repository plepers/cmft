...
void printHelp()
{
    ...
    fprintf(stderr
          , "Usage: cmft [options]\n"
            ...
            "          <dds_outputType> = [cubemap,latlong,hcross,vcross,hstrip,vstrip,facelist,octant,octsplit]\n"
            "          <ktx_outputType> = [cubemap,latlong,hcross,vcross,hstrip,vstrip,facelist,octant,octsplit]\n"
            "          <tga_outputType> = [latlong,hcross,vcross,hstrip,vstrip,facelist,octant,octsplit]\n"
            "          <hdr_outputType> = [latlong,hcross,vcross,hstrip,vstrip,facelist,octant,octsplit]\n"
